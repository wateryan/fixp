...
struct ExecutionReportMessage {
    ...
    tot_no_fills: Option<TotNoFills>,
    ...
    dividend_yield: Option<DividendYield>,
    ...
    time_to_expiration: Option<TimeToExpiration>,
    risk_free_rate: Option<RiskFreeRate>,
...
struct NewsMessage {
    ...
    news_id: Option<NewsID>,
    news_category: Option<NewsCategory>,
    language_code: Option<LanguageCode>,
    market_id: Option<MarketID>,
    market_segment_id: Option<MarketSegmentID>,
}
struct EmailMessage {
...
struct ListStatusMessage {
    ...
    contingency_type: Option<ContingencyType>,
    list_reject_reason: Option<ListRejectReason>,
    rpt_seq: RptSeq,
...
struct QuoteRequestMessage {
    ...
    cl_ord_id: Option<ClOrdID>,
    order_capacity: Option<OrderCapacity>,
    private_quote: Option<PrivateQuote>,
    respondent_type: Option<RespondentType>,
    pre_trade_anonymity: Option<PreTradeAnonymity>,
    text: Option<Text>,
    encoded_text_len: Option<EncodedTextLen>,
    encoded_text: Option<EncodedText>,
...
struct QuoteMessage {
    ...
    quote_id: QuoteID,
    quote_msg_id: Option<QuoteMsgID>,
    quote_resp_id: Option<QuoteRespID>,
...
struct MarketDataSnapshotFullRefreshMessage {
    ...
    m_d_sub_book_type: Option<MDSubBookType>,
    market_depth: Option<MarketDepth>,
    m_d_feed_type: Option<MDFeedType>,
    refresh_indicator: Option<RefreshIndicator>,
    trade_date: Option<TradeDate>,
    ...
    m_d_stream_id: Option<MDStreamID>,
}
...
struct SecurityStatusMessage {
    ...
    security_trading_event: Option<SecurityTradingEvent>,
    financial_status: Option<FinancialStatus>,
    corporate_action: Option<CorporateAction>,
...
struct TradingSessionStatusMessage {
    ...
    trad_ses_event: Option<TradSesEvent>,
...
struct BusinessMessageRejectMessage {
    ...
    ref_appl_ver_id: Option<RefApplVerID>,
    ref_appl_ext_id: Option<RefApplExtID>,
    ref_cstm_appl_ver_id: Option<RefCstmApplVerID>,
...
struct OrderMassCancelReportMessage {
    ...
    secondary_cl_ord_id: Option<SecondaryClOrdID>,
    order_id: OrderID,
    mass_action_report_id: MassActionReportID,
    secondary_order_id: Option<SecondaryOrderID>,
    mass_cancel_request_type: MassCancelRequestType,
...
struct SecurityListRequestMessage {
    ...
    trading_session_sub_id: Option<TradingSessionSubID>,
    subscription_request_type: Option<SubscriptionRequestType>,
    security_list_id: Option<SecurityListID>,
...
struct SecurityListMessage {
    ...
    last_fragment: Option<LastFragment>,
    security_list_id: Option<SecurityListID>,
    security_list_ref_id: Option<SecurityListRefID>,
    security_list_desc: Option<SecurityListDesc>,
    encoded_security_list_desc_len: Option<EncodedSecurityListDescLen>,
    encoded_security_list_desc: Option<EncodedSecurityListDesc>,
    security_list_type: Option<SecurityListType>,
    security_list_type_source: Option<SecurityListTypeSource>,
    transact_time: Option<TransactTime>,
}
...
struct TradeCaptureReportMessage {
    ...
    dividend_yield: Option<DividendYield>,
    risk_free_rate: Option<RiskFreeRate>,
    currency_ratio: Option<CurrencyRatio>,
    copy_msg_indicator: Option<CopyMsgIndicator>,
...
struct UserRequestMessage {
    ...
    encrypted_password_method: Option<EncryptedPasswordMethod>,
    encrypted_password_len: Option<EncryptedPasswordLen>,
    encrypted_password: Option<EncryptedPassword>,
    encrypted_new_password_len: Option<EncryptedNewPasswordLen>,
    encrypted_new_password: Option<EncryptedNewPassword>,
    raw_data_length: Option<RawDataLength>,
    raw_data: Option<RawData>,
}
...
struct SettlementObligationReportMessage {
    clearing_business_date: Option<ClearingBusinessDate>,
    settlement_cycle_no: Option<SettlementCycleNo>,
    settl_oblig_msg_id: SettlObligMsgID,
...
struct DerivativeSecurityListUpdateReportMessage {
    security_req_id: Option<SecurityReqID>,
    security_response_id: Option<SecurityResponseID>,
    security_request_result: Option<SecurityRequestResult>,
    security_update_action: Option<SecurityUpdateAction>,
...
struct TradingSessionListUpdateReportMessage {
    trad_ses_req_id: Option<TradSesReqID>,
}
struct MarketDefinitionRequestMessage {
    market_req_id: MarketReqID,
    subscription_request_type: SubscriptionRequestType,
    market_id: Option<MarketID>,
    market_segment_id: Option<MarketSegmentID>,
    parent_mkt_segm_id: Option<ParentMktSegmID>,
}
struct MarketDefinitionMessage {
    market_report_id: MarketReportID,
    market_req_id: Option<MarketReqID>,
    market_id: MarketID,
    market_segment_id: Option<MarketSegmentID>,
    market_segment_desc: Option<MarketSegmentDesc>,
    encoded_mkt_segm_desc_len: Option<EncodedMktSegmDescLen>,
    encoded_mkt_segm_desc: Option<EncodedMktSegmDesc>,
    parent_mkt_segm_id: Option<ParentMktSegmID>,
    currency: Option<Currency>,
    transact_time: Option<TransactTime>,
    text: Option<Text>,
...
struct MarketDefinitionUpdateReportMessage {
    market_report_id: MarketReportID,
    market_req_id: Option<MarketReqID>,
    market_update_action: Option<MarketUpdateAction>,
    market_id: MarketID,
    market_segment_id: Option<MarketSegmentID>,
    market_segment_desc: Option<MarketSegmentDesc>,
    encoded_mkt_segm_desc_len: Option<EncodedMktSegmDescLen>,
...
struct ApplicationMessageRequestMessage {
    appl_req_id: ApplReqID,
    appl_req_type: ApplReqType,
    text: Option<Text>,
    encoded_text_len: Option<EncodedTextLen>,
    encoded_text: Option<EncodedText>,
}
struct ApplicationMessageRequestAckMessage {
    appl_response_id: ApplResponseID,
    appl_req_id: Option<ApplReqID>,
    appl_req_type: Option<ApplReqType>,
    appl_response_type: Option<ApplResponseType>,
    appl_total_message_count: Option<ApplTotalMessageCount>,
    text: Option<Text>,
    encoded_text_len: Option<EncodedTextLen>,
    encoded_text: Option<EncodedText>,
}
struct ApplicationMessageReportMessage {
    appl_report_id: ApplReportID,
    appl_report_type: ApplReportType,
    text: Option<Text>,
    encoded_text_len: Option<EncodedTextLen>,
    encoded_text: Option<EncodedText>,
    appl_req_id: Option<ApplReqID>,
}
struct OrderMassActionReportMessage {
    cl_ord_id: Option<ClOrdID>,
    secondary_cl_ord_id: Option<SecondaryClOrdID>,
    mass_action_report_id: MassActionReportID,
    ...
    mass_action_reject_reason: Option<MassActionRejectReason>,
    total_affected_orders: Option<TotalAffectedOrders>,
    market_id: Option<MarketID>,
    market_segment_id: Option<MarketSegmentID>,
    trading_session_id: Option<TradingSessionID>,
...
struct OrderMassActionRequestMessage {
    cl_ord_id: ClOrdID,
    secondary_cl_ord_id: Option<SecondaryClOrdID>,
    mass_action_type: MassActionType,
    mass_action_scope: MassActionScope,
...
struct UserNotificationMessage {
    user_status: UserStatus,
    text: Option<Text>,
    encoded_text_len: Option<EncodedTextLen>,
    encoded_text: Option<EncodedText>,
}
struct StreamAssignmentRequestMessage {
    stream_asgn_req_id: StreamAsgnReqID,
    stream_asgn_req_type: StreamAsgnReqType,
}
struct StreamAssignmentReportMessage {
    stream_asgn_rpt_id: StreamAsgnRptID,
    stream_asgn_req_type: Option<StreamAsgnReqType>,
    stream_asgn_req_id: Option<StreamAsgnReqID>,
}
struct StreamAssignmentReportACKMessage {
    stream_asgn_ack_type: StreamAsgnAckType,
    stream_asgn_rpt_id: StreamAsgnRptID,
    stream_asgn_rej_reason: Option<StreamAsgnRejReason>,
    text: Option<Text>,
    encoded_text_len: Option<EncodedTextLen>,
    encoded_text: Option<EncodedText>,
}
